...
define config.name = _("여름, 그녀 (Summer, Kanojo)")
...
#버전정보 수정
define gui.about = _("""\
{font=NanumGothicBold.ttf}{color=#660066}{size=+3}개발자{/size}{/color}{/font}
{a=https://anthony-o.notion.site/}{font=NanumGothic.ttf}{size=-3}{color=#660066}Anthony_O{/color}{/size}{/font}{/a} - Game Design, Programming 담당 (기획지망생).
해당 게임은 제 첫 작품입니다. 부족한 부분이 있어도 너그러이 피드백 부탁드립니다.
본 작품은 네이버의 '나눔바른펜, 나눔고딕' 글꼴을 사용하여 제작하였습니다.

{font=NanumGothicBold.ttf}{color=#660066}{size=+3}Thanks To.{/size}{/color}{/font}
디자이너 (아트 디렉터), 사운드 엔지니어 섭외예정
""")
#{a=https://www.instagram.com/s_m1n0/}{font=NanumGothic.ttf}{size=-3}{color=#660066}S.min{/color}{/size}{/font}{/a}(섭외예정) - Art Work.
#{a=https://www.youtube.com/@TBWCllamat}{font=NanumGothic.ttf}{size=-3}{color=#660066}TBW{/color}{/size}{/font}{/a}(섭외예정) - Sound engineer.


## 배포판의 실행 파일과 디렉토리에 사용되는 게임의 약식 이름. 이것은 ASCII 전용
## 이어야 하며 공백, 콜론 또는 세미콜론을 포함해서는 안 됩니다.

define build.name = "Summ_Kano"
...
define config.save_directory = "Summer_Kano-1720583240"
